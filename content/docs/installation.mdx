---
title: Installation
description: Install & configure @liqo/sdk
---
...
- For edge runtimes (Cloudflare Workers, Vercel Edge, Deno, Bun), see [examples/RUNTIME_COMPATIBILITY.md](https://github.com/liqoprotocol/liqo-sdk/blob/main/examples/RUNTIME_COMPATIBILITY.md).
