---
title: Changelog
description: Notable changes to @liqo/sdk, by version
---

Mirrors [`CHANGELOG.md`](https://github.com/liqoprotocol/liqo-sdk/blob/main/CHANGELOG.md) in the SDK
repository, which stays the source of truth. Format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/);
`@liqo/sdk` follows [Semantic Versioning](/docs/versioning).
