---
title: Introduction
description: What Liqo is and how the SDK fits
---
...
See [Payments](/docs/payments) and [Transactions](/docs/transactions) for detail.
...
- [Use Cases](/docs/use-cases) — real integration patterns, with code
- [Getting Started](/docs/getting-started) — your first payment
- [Authentication](/docs/authentication) — keys & environments
- [API Reference](/docs/api-reference) — the complete surface
